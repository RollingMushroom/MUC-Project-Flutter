...
class MalaysianFoodDetailPageguest extends StatefulWidget {
  ...
  const MalaysianFoodDetailPageguest({
    super.key,
    this.packageName,
    ...
    required this.password, // Add the new parameter
  });

  // ignore: library_private_types_in_public_api, unused_element, non_constant_identifier_names
  @override
  // ignore: library_private_types_in_public_api
  _MalaysianFoodDetailPageguestState createState() =>
      _MalaysianFoodDetailPageguestState();
}

class _MalaysianFoodDetailPageguestState
    extends State<MalaysianFoodDetailPageguest> {
  int quantity = 1;
