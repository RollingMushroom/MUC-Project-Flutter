...
import 'malaysian_food_detail_pageguest.dart';
...
class MenuDetailsPageguest extends StatefulWidget {
  final Users user;
  final String name;
  final String email;
  final String phone;
...
class _MenuDetailsPageState extends State<MenuDetailsPageguest>
  ...
  void navigateToDetailPage(MalaysianFoodPackageModel meal) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => MalaysianFoodDetailPageguest(
          user: widget.user,
          name: widget.name,
          email: widget.email,
          phone: widget.phone,
